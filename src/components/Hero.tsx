  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 w-full mx-auto text-stone-800 pt-32 md:pt-40 flex flex-col items-center">
        ...
        <div className="w-[90%] max-w-[600px] mx-auto mt-8 flex flex-col items-center gap-4 animate-[slideUp_0.8s_ease-out_0.3s_both]">

          {/* Top Row: Two buttons side by side */}
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            <Link
              href="#categorias"
              className="group flex-1 flex items-center justify-center py-4 bg-stone-900 text-white uppercase tracking-widest text-xs font-bold rounded-sm hover:bg-stone-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 text-center px-4"
            >
            ...
            <Link
              ...
              className="group flex-1 flex items-center justify-center py-4 border-2 border-stone-900 text-stone-900 uppercase tracking-widest text-xs font-bold rounded-sm hover:bg-stone-900 hover:text-white transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 text-center px-4"
            >
              <div className="flex items-center gap-2 whitespace-nowrap">
          ...
          {/* Bottom Row: Full width catalog button */}
          <Link
            href="https://www.canva.com/design/DAHCEUG3MWk/1K2Xnfb58dOmrtfzpdBR6g/view?utlId=hdb7ce7156f"
            target="_blank"
            className="group flex flex-row items-center justify-center w-full py-4 border border-stone-300 bg-white/50 backdrop-blur-sm text-stone-700 uppercase tracking-widest text-xs font-bold rounded-sm hover:bg-stone-100 hover:text-stone-900 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 text-center px-4"
          >
            <div className="flex items-center gap-2 whitespace-nowrap">
