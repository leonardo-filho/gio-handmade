...
export default function Contact() {
  return (
    <CatalogFrame page="10 · CONTATO" tone="ink" full id="contato">
      <div className="max-w-7xl mx-auto w-full text-center">
        ...
        <Reveal delay={0.16}>
          <h2 className="mt-6 font-[family-name:var(--font-display)] font-black uppercase leading-[0.85] tracking-[-0.045em] text-[#EDE7D9] text-[clamp(3.4rem,11vw,10rem)]">
            VAMOS<br />ENCOMENDAR.
          </h2>
        </Reveal>
        ...
        <Reveal delay={0.22}>
          <p className="mt-10 font-[family-name:var(--font-serif)] italic text-[#C8E1E4]/85 text-xl md:text-2xl max-w-2xl mx-auto leading-snug">
            Cada peça nasce pensando só em você. Me chama no WhatsApp e a gente desenha a sua a quatro mãos.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="mt-10 flex flex-col items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#C8E1E4] text-[#130209] px-8 py-4 text-[11px] tracking-[0.32em] uppercase font-[family-name:var(--font-display)] font-bold hover:bg-[#EDE7D9] transition-colors"
            >
              Reservar minha peça no WhatsApp
