        ...
        <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#130209]/15 border border-[#130209]/15">
          ...
          <Reveal delay={0.04 + care.length * 0.04} className="sm:col-span-2 lg:col-span-1">
            <li className="bg-[#1B4965] p-7 md:p-10 h-full flex flex-col justify-between gap-6 text-[#EDE7D9]">
              ...
              <p className="font-[family-name:var(--font-serif)] italic text-[#EDE7D9] text-xl md:text-2xl leading-snug max-w-xl">
                Obrigada por escolher o feito à mão. Cuide dessa peça como ela é, especial.
              </p>
              <div className="flex flex-col gap-1 text-[11px] tracking-[0.18em] uppercase font-[family-name:var(--font-display)] text-[#C8E1E4]/80">
                <span>Dúvidas? Fala com a gente</span>
                <span className="text-[#EDE7D9] tracking-[0.08em] normal-case text-sm">@gio.handmade__</span>
                <span className="text-[#EDE7D9] tracking-[0.08em] normal-case text-sm">(91) 99298-2017</span>
                <span className="text-[#EDE7D9] tracking-[0.08em] normal-case text-sm">giohandmade.com.br</span>
              </div>
            </li>
          </Reveal>
        </ul>
