export default function ProcessSection() {
  const steps = [
    ...
    },
    {
      num: "03",
      title: "Medidas",
      text: "Ficou com dúvida? Eu te ajudo pelo WhatsApp enviando um vídeo explicativo para tirar as medidas com perfeição.",
      icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      num: "04",
      title: "Confecção",
      text: "O prazo de produção é de 7 a 30 dias úteis. Tem urgência para uma data especial? Me chame no WhatsApp para checarmos a agenda!",
      highlight: "Prazo",
      icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
